...
For more information about Transportadora please go to https://codex.wordpress.org/Twenty_Seventeen_Transportadora.

== Installation ==

1. In your admin panel, go to Appearance -> Themes and click the 'Add New' button.
2. Type in Transportadora in the search form and press the 'Enter' key on your keyboard.
3. Click on the 'Activate' button to use your new theme right away.
4. Go to https://codex.wordpress.org/Twenty_Seventeen_Transportadora for a guide on how to customize this theme.
5. Navigate to Appearance > Customize in your admin panel and customize to taste.

== Copyright ==

Transportadora WordPress Theme, Copyright 2016 WordPress.org
Transportadora is distributed under the terms of the GNU GPL
...
Transportadora bundles the following third-party resources:
