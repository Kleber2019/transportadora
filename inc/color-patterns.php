 ...
 */
function transportadora_custom_colors_css() {
	$hue = absint( get_theme_mod( 'colorscheme_hue', 250 ) );

	/**
	 * Filter Transportadora default saturation level.
	 *
	 * @since Transportadora 1.0
	 *
	 * @param int $saturation Color saturation level.
	 */
	$saturation         = absint( apply_filters( 'transportadora_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.transportadora-front-page) .entry-title,
...
.colors-custom.transportadora-front-page .panel-content .recent-posts article,
...
.colors-custom.transportadora-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	...
	/**
	 * Filters Transportadora custom colors CSS.
	 *
	 * @since Transportadora 1.0
	 *
	 ...
	 */
	return apply_filters( 'transportadora_custom_colors_css', $css, $hue, $saturation );
}
